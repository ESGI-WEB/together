...
| **Types d'évènements** | - Les utilisateurs peuvent choisir le type d'évènement qu'ils veulent créer, un icone s'affiche. <br> - Les administrateurs peuvent ajouter des types d'évènements.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
